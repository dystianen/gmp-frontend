            ...
            <div className="bg-[#FAFAFA] h-screen">
                <Card className={'h-screen rounded-2xl mx-10 -mt-[80px] pb-20'}>
                    <div className="my-2 flex flex-col items-center justify-center">
                        ...
                        <p className=" text-center font-semibold text-2xl text-[#4461F2] mt-1">$50</p>
                    </div>
                    <hr className="w-full"/>
                    ...
                    <div className="grid grid-cols-2 gap-4 font-medium text-sm">
                        ...
                        <div>Tanggal</div>
                        <div className="text-right">09 September 2022</div>
                        <div>ID Transaksi</div>
                        <div className="text-right">0474755949398</div>
                        <div>Order ID</div>
